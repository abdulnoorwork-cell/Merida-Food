      ...
      <div className="container mx-auto py-16 px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          {blogLoading ? <img src={loading_animation} alt='loader' className='mx-auto lg:col-span-2' /> : <div className="lg:col-span-2">
            {/* Blog Cards */}
            {blogs.length > 0 ? <div className="blogs grid grid-cols-2 gap-6">
              {blogs.map((blog, index) => (
                <BlogCard key={index} blog={blog} />
              ))}
            </div> : <div className='font-medium h-full bg-gray-100 text-lg flex items-center justify-center text-center rounded-md w-full'>You don,t have any blogs</div>}
          </div>}
