...
const Login = () => {
  ...
  return (
    <div className='bg-cover bg-no-repeat text-white' style={{ backgroundImage: `url(${backgroundImage})` }}>
      <div className='flex items-center justify-center h-screen'>
        <div className='w-full max-w-lg p-6 max-md:m-4 rounded-lg bg-black/30 backdrop-blur-xs'>
          <div className='flex flex-col items-center justify-center'>
            ...
            <div className='text-sm'>
              <h6 className='text-orange-500 font-medium'>Admin Email: <span className='text-white font-normal'>abdulnoorwork@gmail.com</span></h6>
