...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex w-full h-fit justify-center px-4 py-8 md:px-8 lg:py-10 h-full min-h-[85vh]'>
      <div className='bg-black/30 backdrop-blur-xs flex flex-col w-full max-w-[700px] p-6 md:p-10 shadow rounded-xl'>
        <label htmlFor="image">
