        ...
        <div className='pb-20'>
            ...
            <div className="relative lg:h-[430px] md:h-[380px] h-[300px] w-full">
                ...
                <div className="container mx-auto absolute inset-0 flex flex-col md:flex-row md:items-center md:justify-between justify-center px-4 text-white">
                    <div>
                        <p className="md:flex-1 xl:text-6xl lg:text-5xl md:text-[44px] text-[40px] font-semibold md:mb-4 mb-2.5 leading-tight">Wishlist</p>
                    </div>
            ...
            <div className='pt-20 container mx-auto px-4'>
                <h6 className='text-sm mb-1'>Home / <span className='text-orange-500'>Wishlist</span></h6>
                <p className="text-4xl font-bold mb-8 tracking-tight">Your Wishlist</p>
